...
function Room:updateColliders()
    ...
    if self.roomNumber == 3 then
        ...
        local enemy1 = Enemy(210, 205, true, false, 1, Trackers.night.night1.rooms.room3.enemies[1])
        local enemy2 = Enemy(240, 205, true, false, 2, Trackers.night.night1.rooms.room3.enemies[2])
